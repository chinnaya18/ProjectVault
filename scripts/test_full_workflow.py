...
def test_workflow():
    ...
    print(f"✓ Step 1: Student Logged In (User #{student_id})")
    ...
    print(f"✓ Step 2: Retrieved Department '{dept_name}' (ID #{dept_id})")
    ...
    project_payload = {
        ...
        "members": [{"userEmail": "25mx101@university.edu", "memberRole": "Project Lead / Author"}]
    }
    ...
    print(f"✓ Step 3: Student Created Project Draft #{proj_id}: '{proj_res['data']['title']}' [Status: {proj_res['data']['status']}]")
    ...
    print(f"✓ Step 4: Student Submitted Project #{proj_id} for Faculty Review [Status: {submit_res['data']['status']}]")
    ...
    print(f"✓ Step 5: Faculty Logged In (Geetha)")
    ...
    print(f"✓ Step 6a: Faculty Moved Project #{proj_id} to [Status: UNDER_REVIEW]")
    ...
    print(f"✓ Step 6b: Faculty APPROVED Project #{proj_id}! [Status: APPROVED]")
    ...
    print(f"✓ Step 7: Public Visitor Catalog correctly displays {len(pub_projects)} approved project: '{pub_projects[0]['title']}'")
    ...
    print(f"✓ Step 8: System Admin retrieved {user_count} registered users from User Management Directory.")
